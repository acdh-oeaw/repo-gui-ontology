    ...
    */
    ...
    CKEDITOR.plugins.add('collection', {
        ...
        init: function (editor) {
            editor.addCommand( 'insertCollection', {
                exec: function( editor ) {
                    
                    let data = CKEDITOR.ajax.load( 'https://'+ window.location.host+'/browser/api/getOntologyJSPluginData/en?_format=json' );
                    let obj = JSON.parse(data);
                    editor.insertHtml( obj.text );
                }
            });
            
            editor.ui.addButton( 'Collection', {
                label: 'Insert Collection',
                command: 'insertCollection',
                toolbar: 'insert'
            });
        }
    });
